...
//Select whetehr food id is set or not
    if(isset($_GET['food_id'])) 
    {
        //Get the food id and details of the selected food
        $food_id = $_GET['food_id'];

        //Get the details of the selecte food
        ...
        <div class="container">
            ...
            <form action="" method="POST" class="order">
                ...
                <fieldset>
                    ...
                    <input type="text" name="full-name" placeholder="E.g. Patrick Gitungo" class="input-responsive" required>
            ...
            if(isset($_POST['submit']))
            {
                ...
                $price = $_POST['price'];
                $qty = $_POST['qty'];
                $total = $price * $qty; //total = price xqty
            ...
            if($res2==true)
            {
                //Query executed and ooder saved
